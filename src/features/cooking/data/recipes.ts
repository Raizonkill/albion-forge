...
export interface CookingRecipe {
  ...
  output: number
  nutrition: number
  /** Sum of ingredient item values (drives the station fee). */
  craftValue: number
  avalon: boolean
...
export const COOKING_RECIPES: CookingRecipe[] = [
  { id: "T1_MEAL_SOUP", name: "Sopa de zanahoria", tipo: "Sopas", tier: 1, output: 10, nutrition: 77, craftValue: 640, avalon: false,
    focusByEnchant: [560, 780, 1230, 2560], sauceByEnchant: [0, 10, 10, 10],
    ingredientes: [{ id: "T1_CARROT", name: "Zanahorias", qty: 16 }] },
  { id: "T1_MEAL_SOUP_FISH", name: "Sopa de almeja verdosa", tipo: "Sopas", tier: 1, output: 1, nutrition: 106, craftValue: 90, avalon: false,
  ...
  { id: "T2_MEAL_SALAD", name: "Ensalada de frijoles", tipo: "Ensaladas", tier: 2, output: 10, nutrition: 77, craftValue: 640, avalon: false,
    focusByEnchant: [560, 780, 1230, 2560], sauceByEnchant: [0, 10, 10, 10],
    ingredientes: [{ id: "T2_BEAN", name: "Frijoles", qty: 8 }, { id: "T1_CARROT", name: "Zanahorias", qty: 8 }] },
  { id: "T2_MEAL_SALAD_FISH", name: "Ensalada de calamar de aguas poco profundas", tipo: "Ensaladas", tier: 2, output: 1, nutrition: 106, craftValue: 90, avalon: false,
    focusByEnchant: [77, 144, 278, 678], sauceByEnchant: [0, 3, 3, 3],
  ...
  { id: "T3_MEAL_OMELETTE", name: "Tortilla de pollo", tipo: "Tortillas", tier: 3, output: 10, nutrition: 77, craftValue: 560, avalon: false,
  ...
  { id: "T3_MEAL_OMELETTE_AVALON", name: "Tortilla de pollo avaloniana", tipo: "Tortillas", tier: 3, output: 10, nutrition: 84, craftValue: 1200, avalon: true,
    focusByEnchant: [520, 740, 1180, 2520], sauceByEnchant: [0, 10, 10, 10],
  ...
  { id: "T3_MEAL_OMELETTE_FISH", name: "Tortilla de cangrejo de r\u00edo abajo", tipo: "Tortillas", tier: 3, output: 1, nutrition: 116, craftValue: 90, avalon: false,
    focusByEnchant: [77, 144, 278, 678], sauceByEnchant: [0, 3, 3, 3],
  ...
  { id: "T3_MEAL_PIE", name: "Pastel de pollo", tipo: "Pasteles", tier: 3, output: 10, nutrition: 78, craftValue: 560, avalon: false,
  ...
  { id: "T3_MEAL_PIE_FISH", name: "Pastel de ojo muerto de las sierras", tipo: "Pasteles", tier: 3, output: 1, nutrition: 120, craftValue: 90, avalon: false,
  ...
  { id: "T3_MEAL_ROAST", name: "Pollo asado", tipo: "Asados", tier: 3, output: 10, nutrition: 87, craftValue: 640, avalon: false,
  ...
  { id: "T3_MEAL_ROAST_FISH", name: "Pargo de niebla blanca asado", tipo: "Asados", tier: 3, output: 1, nutrition: 116, craftValue: 90, avalon: false,
    focusByEnchant: [77, 144, 278, 678], sauceByEnchant: [0, 3, 3, 3],
  ...
  { id: "T3_MEAL_SOUP", name: "Sopa de trigo", tipo: "Sopas", tier: 3, output: 10, nutrition: 252, craftValue: 1920, avalon: false,
    focusByEnchant: [1680, 2350, 3680, 7690], sauceByEnchant: [0, 30, 30, 30],
    ingredientes: [{ id: "T3_WHEAT", name: "Manojo de trigo", qty: 48 }] },
  { id: "T3_MEAL_SOUP_FISH", name: "Sopa de almeja de aguas turbias", tipo: "Sopas", tier: 3, output: 1, nutrition: 345, craftValue: 260, avalon: false,
  ...
  { id: "T4_MEAL_SALAD", name: "Ensalada de r\u00e1bano", tipo: "Ensaladas", tier: 4, output: 10, nutrition: 252, craftValue: 1920, avalon: false,
    focusByEnchant: [1680, 2350, 3680, 7690], sauceByEnchant: [0, 30, 30, 30],
    ingredientes: [{ id: "T4_TURNIP", name: "R\u00e1banos", qty: 24 }, { id: "T3_WHEAT", name: "Manojo de trigo", qty: 24 }] },
  { id: "T4_MEAL_SALAD_FISH", name: "Ensalada de pulpo de aguas medias", tipo: "Ensaladas", tier: 4, output: 1, nutrition: 345, craftValue: 260, avalon: false,
    focusByEnchant: [231, 432, 832, 2033], sauceByEnchant: [0, 9, 9, 9],
  ...
  { id: "T4_MEAL_SANDWICH", name: "Bocadillo de cabra", tipo: "Bocadillos", tier: 4, output: 10, nutrition: 81, craftValue: 560, avalon: false,
  ...
  { id: "T4_MEAL_SANDWICH_AVALON", name: "Bocadillo de cabra avaloniano", tipo: "Bocadillos", tier: 4, output: 10, nutrition: 88, craftValue: 1200, avalon: true,
    focusByEnchant: [550, 770, 1220, 2550], sauceByEnchant: [0, 10, 10, 10],
  ...
  { id: "T4_MEAL_SANDWICH_FISH", name: "Bocadillo de locha pedregosa", tipo: "Bocadillos", tier: 4, output: 1, nutrition: 120, craftValue: 90, avalon: false,
    focusByEnchant: [81, 147, 281, 681], sauceByEnchant: [0, 3, 3, 3],
  ...
  { id: "T4_MEAL_STEW", name: "Guiso de cabra", tipo: "Guisos", tier: 4, output: 10, nutrition: 91, craftValue: 640, avalon: false,
  ...
  { id: "T4_MEAL_STEW_AVALON", name: "Guiso de cabra avaloniano", tipo: "Guisos", tier: 4, output: 10, nutrition: 94, craftValue: 1280, avalon: true,
    focusByEnchant: [580, 810, 1250, 2590], sauceByEnchant: [0, 10, 10, 10],
  ...
  { id: "T4_MEAL_STEW_FISH", name: "Guiso de anguila de agua verdosa", tipo: "Guisos", tier: 4, output: 1, nutrition: 116, craftValue: 90, avalon: false,
    focusByEnchant: [77, 144, 278, 678], sauceByEnchant: [0, 3, 3, 3],
  ...
  { id: "T5_MEAL_OMELETTE", name: "Tortilla de ganso", tipo: "Tortillas", tier: 5, output: 10, nutrition: 230, craftValue: 1680, avalon: false,
  ...
  { id: "T5_MEAL_OMELETTE_AVALON", name: "Tortilla de ganso avaloniana", tipo: "Tortillas", tier: 5, output: 10, nutrition: 252, craftValue: 3600, avalon: true,
    focusByEnchant: [1550, 2220, 3550, 7550], sauceByEnchant: [0, 30, 30, 30],
  ...
  { id: "T5_MEAL_OMELETTE_FISH", name: "Tortilla de cangrejo de r\u00edo", tipo: "Tortillas", tier: 5, output: 1, nutrition: 337, craftValue: 260, avalon: false,
  ...
  { id: "T5_MEAL_PIE", name: "Pastel de ganso", tipo: "Pasteles", tier: 5, output: 10, nutrition: 266, craftValue: 1920, avalon: false,
  ...
  { id: "T5_MEAL_PIE_FISH", name: "Pastel de ojo muerto de las monta\u00f1as", tipo: "Pasteles", tier: 5, output: 1, nutrition: 337, craftValue: 260, avalon: false,
    focusByEnchant: [225, 425, 825, 2026], sauceByEnchant: [0, 9, 9, 9],
  ...
  { id: "T5_MEAL_ROAST", name: "Ganso asado", tipo: "Asados", tier: 5, output: 10, nutrition: 262, craftValue: 1920, avalon: false,
  ...
  { id: "T5_MEAL_ROAST_FISH", name: "Pargo de niebla ligera asado", tipo: "Asados", tier: 5, output: 1, nutrition: 337, craftValue: 260, avalon: false,
    focusByEnchant: [225, 425, 825, 2026], sauceByEnchant: [0, 9, 9, 9],
  ...
  { id: "T5_MEAL_SOUP", name: "Sopa de col", tipo: "Sopas", tier: 5, output: 10, nutrition: 756, craftValue: 5760, avalon: false,
    focusByEnchant: [5040, 7040, 11050, 23060], sauceByEnchant: [0, 90, 90, 90],
    ingredientes: [{ id: "T5_CABBAGE", name: "Coles", qty: 144 }] },
  { id: "T5_MEAL_SOUP_FISH", name: "Sopa de almeja de pantano negro", tipo: "Sopas", tier: 5, output: 1, nutrition: 1002, craftValue: 750, avalon: false,
  ...
  { id: "T6_MEAL_SALAD", name: "Ensalada de patata", tipo: "Ensaladas", tier: 6, output: 10, nutrition: 756, craftValue: 5760, avalon: false,
    focusByEnchant: [5040, 7040, 11050, 23060], sauceByEnchant: [0, 90, 90, 90],
    ingredientes: [{ id: "T6_POTATO", name: "Patatas", qty: 72 }, { id: "T5_CABBAGE", name: "Coles", qty: 72 }] },
  { id: "T6_MEAL_SALAD_FISH", name: "Ensalada de kraken de agua profunda", tipo: "Ensaladas", tier: 6, output: 1, nutrition: 1002, craftValue: 750, avalon: false,
    focusByEnchant: [672, 1272, 2473, 6076], sauceByEnchant: [0, 27, 27, 27],
  ...
  { id: "T6_MEAL_SANDWICH", name: "Bocadillo de carnero", tipo: "Bocadillos", tier: 6, output: 10, nutrition: 243, craftValue: 1680, avalon: false,
  ...
  { id: "T6_MEAL_SANDWICH_AVALON", name: "Bocadillo de cordero avaloniano", tipo: "Bocadillos", tier: 6, output: 10, nutrition: 265, craftValue: 3600, avalon: true,
    focusByEnchant: [1650, 2310, 3650, 7650], sauceByEnchant: [0, 30, 30, 30],
  ...
  { id: "T6_MEAL_SANDWICH_FISH", name: "Bocadillo de locha de agua corriente", tipo: "Bocadillos", tier: 6, output: 1, nutrition: 345, craftValue: 260, avalon: false,
    focusByEnchant: [231, 432, 832, 2033], sauceByEnchant: [0, 9, 9, 9],
  ...
  { id: "T6_MEAL_STEW", name: "Guiso de carnero", tipo: "Guisos", tier: 6, output: 10, nutrition: 272, craftValue: 1920, avalon: false,
  ...
  { id: "T6_MEAL_STEW_AVALON", name: "Guiso de cordero avaloniano", tipo: "Guisos", tier: 6, output: 10, nutrition: 283, craftValue: 3840, avalon: true,
    focusByEnchant: [1760, 2430, 3760, 7770], sauceByEnchant: [0, 30, 30, 30],
  ...
  { id: "T6_MEAL_STEW_FISH", name: "Guiso de anguila rojiza", tipo: "Guisos", tier: 6, output: 1, nutrition: 337, craftValue: 260, avalon: false,
    focusByEnchant: [225, 425, 825, 2026], sauceByEnchant: [0, 9, 9, 9],
  ...
  { id: "T7_MEAL_OMELETTE", name: "Tortilla de cerdo", tipo: "Tortillas", tier: 7, output: 10, nutrition: 690, craftValue: 5040, avalon: false,
  ...
  { id: "T7_MEAL_OMELETTE_AVALON", name: "Tortilla de cerdo avaloniana", tipo: "Tortillas", tier: 7, output: 10, nutrition: 755, craftValue: 10800, avalon: true,
    focusByEnchant: [4640, 6650, 10650, 22660], sauceByEnchant: [0, 90, 90, 90],
  ...
  { id: "T7_MEAL_OMELETTE_FISH", name: "Tortilla de cangrejo de pozo", tipo: "Tortillas", tier: 7, output: 1, nutrition: 1002, craftValue: 750, avalon: false,
    focusByEnchant: [672, 1272, 2473, 6076], sauceByEnchant: [0, 27, 27, 27],
  ...
  { id: "T7_MEAL_PIE", name: "Pastel de cerdo", tipo: "Pasteles", tier: 7, output: 10, nutrition: 799, craftValue: 5760, avalon: false,
  ...
  { id: "T7_MEAL_PIE_FISH", name: "Pastel de ojo muerto dos picos", tipo: "Pasteles", tier: 7, output: 1, nutrition: 1002, craftValue: 750, avalon: false,
    focusByEnchant: [672, 1272, 2473, 6076], sauceByEnchant: [0, 27, 27, 27],
  ...
  { id: "T7_MEAL_ROAST", name: "Cerdo asado", tipo: "Asados", tier: 7, output: 10, nutrition: 785, craftValue: 5760, avalon: false,
  ...
  { id: "T7_MEAL_ROAST_FISH", name: "Pargo de niebla pura asado", tipo: "Asados", tier: 7, output: 1, nutrition: 978, craftValue: 750, avalon: false,
  ...
  { id: "T8_MEAL_SANDWICH", name: "Bocadillo de ternera", tipo: "Bocadillos", tier: 8, output: 10, nutrition: 730, craftValue: 5040, avalon: false,
  ...
  { id: "T8_MEAL_SANDWICH_AVALON", name: "Bocadillo de ternera avaloniano", tipo: "Bocadillos", tier: 8, output: 10, nutrition: 795, craftValue: 10800, avalon: true,
    focusByEnchant: [4940, 6940, 10940, 22950], sauceByEnchant: [0, 90, 90, 90],
  ...
  { id: "T8_MEAL_SANDWICH_FISH", name: "Bocadillo de locha de trueno", tipo: "Bocadillos", tier: 8, output: 1, nutrition: 1002, craftValue: 750, avalon: false,
    focusByEnchant: [672, 1272, 2473, 6076], sauceByEnchant: [0, 27, 27, 27],
  ...
  { id: "T8_MEAL_STEW", name: "Guiso de ternera", tipo: "Guisos", tier: 8, output: 10, nutrition: 817, craftValue: 5760, avalon: false,
  ...
  { id: "T8_MEAL_STEW_AVALON", name: "Guiso de ternera avaloniano", tipo: "Guisos", tier: 8, output: 10, nutrition: 850, craftValue: 11520, avalon: true,
    focusByEnchant: [5280, 7280, 11280, 23290], sauceByEnchant: [0, 90, 90, 90],
  ...
  { id: "T8_MEAL_STEW_FISH", name: "Guiso de anguila de agua podrida", tipo: "Guisos", tier: 8, output: 1, nutrition: 978, craftValue: 750, avalon: false,
    focusByEnchant: [652, 1253, 2454, 6056], sauceByEnchant: [0, 27, 27, 27],
